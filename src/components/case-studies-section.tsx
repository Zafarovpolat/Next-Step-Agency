  ...
  const caseStudies = [
    {
      ...
      testimonial: "Разработали элегантный сайт для влиятельного архитектурного бюро России, подчеркнув их инновационный подход и статус.",
    },
    {
      ...
      testimonial: "Создали функциональный сайт для производителя кулинарных изделий. Яркий стиль и удобная мобильная версия стали ключом к их цифровому присутствию.",
    },
    {
      client: "Testana",
      image: "/project3.png",
      ...
      testimonial: "Разработали безопасный маркетплейс для продажи скриптов, который позволяет авторам легко публиковать работы, а покупателям — находить нужные инструменты.",
    },
    {
    ...
    },
    {
      ...
      stack: ["html", "css", "js"],
      testimonial: "Разработали официальный сайт для предприятия крупного промышленного холдинга, отражающий их промышленную мощь и инженерный опыт.",
    },
  ];
